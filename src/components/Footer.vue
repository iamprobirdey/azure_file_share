<template>
  <div class="items-center">
    <footer
      class="text-blueGray-700 transition duration-500 ease-in-out transform bg-white border rounded-lg"
    >
      <div
      ...
      >
        ...
        >
          <div class="pr-2 lg:pr-8 lg:px-6">
            ...
            <p
              class="mb-10 text-xs font-semibold tracking-widest text-black uppercase title-font"
            >
              Wanna have some fun with file share,right?
            </p>
        ...
        <div
          class="flex flex-wrap flex-grow mt-8 -mb-10 text-left md:pl-20 md:mt-0"
        >
          ...
          <div class="w-full px-4 lg:w-1/3 md:w-1/2">
            ...
            <nav class="mb-10">
              <div class="flex flex-wrap space-y-4">
                <button
                  class="inline-flex items-center px-5 py-3 text-black rounded-xl bg-blueGray-50 hover:bg-black hover:text-white focus:outline-none"
                >
                  <svg
